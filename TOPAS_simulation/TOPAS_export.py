...
#Inside the folder of topas,a folder for each patient will be created, and inside this folder the folders for each beam, and inside each beam folder, the files for each control point with the correct number of scan spots will be created.
...
#And inside plan_hu.txt, you need to change the line includeFile='plan.txt' to : Protons_01/plan.txt
