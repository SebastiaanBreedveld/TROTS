...
#In order to compile the full beamlet Range, use run_all.txt, if you want just one control point (energy layer), chooose the correct run_CP#.txt                                

#The specific arguments written in writeTROTStoDICOM.py are the following:
...
parser.add_argument("-s", "--OutputPath", nargs='?', help="The output directory where the TOPAS script files will be written to.", default="/tmp")
...
#This file is copied from https://github.com/topasmc/dicom-interface/blob/master/rti/topas/tutorial/beam.txt and https://github.com/topasmc/dicom-interface/blob/master/rti/topas/tutorial/inputs.txt
...
### geometry for only patient calculation
#####################################################
####################################################
### RangeShifter/Aperture/Compensator become a mass
...
s:Ge/RTION/File        = Rt/RTION/PlanFile 
...
# TOPAS extension will set up these parameters on-the-fly
...
b:Ts/ShowCPUTime = "T"               
i:Ts/NumberOfThreads = {args.numberOfThreads}
...
"""
                    ...
                    schneiderTemplate=f"""
#This file is copied from https://github.com/topasmc/dicom-interface/tree/master/rti/topas/tutorial/plan_hu.txt

# For TOPAS 3.5
b:Ge/Patient/SchneiderUseVariableDensityMaterials = "True"

###################################################
#---- Cut values for Patient calculations ----#
###################################################
d:Ph/Default/CutForElectron = 0.4 mm # overrides CutForAllParticles for Electron
d:Ph/Default/CutForPositron = 0.4 mm # overrides CutForAllParticles for Positron
d:Ph/Default/CutForProton   = 0.4 mm # overrides CutForAllParticles for Proton
d:Ph/Default/CutForAlpha    = 0.4 mm # overrides CutForAllParticles for Alpha
d:Ph/Default/CutForDeuteron = 0.4 mm # overrides CutForAllParticles for Deuteron
d:Ph/Default/CutForTriton   = 0.4 mm # overrides CutForAllParticles for Triton

#this file was originally HUtoMaterialSchneider.txt 
